...
from .views import PacientesCreateView, PacientesListView, PacientesUpdateView, PacientesDeleteView, PacientesDetailView
...
urlpatterns = patterns('',
    ...
    url(r'^detail/(?P<pk>\d+)$', PacientesDetailView.as_view(), name='detail'),
